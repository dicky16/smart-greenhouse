...
<!-- //js -->
<link href="{{ asset('user/css/mislider.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('user/css/mislider-custom.css') }}" rel="stylesheet" type="text/css" />
<!-- font-awesome-icons -->
	...
	<div class="welcome">
		...
		<div class="mis-stage w3_agileits_welcome_grids"> 
			...
			<ol class="mis-slider">
				<li class="mis-slide"> 
					<figure> 
						<img src="{{ asset('user/images/2.png') }}" alt=" " class="img-responsive" />
						<figcaption>Strawberry</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="{{ asset('user/images/3.png') }}" alt=" " class="img-responsive" />
						<figcaption>Orange</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="{{ asset('user/images/4.png') }}" alt=" " class="img-responsive" />
						<figcaption>Pomegranates</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="{{ asset('user/images/5.png') }}" alt=" " class="img-responsive" />
						<figcaption>Lemon</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="{{ asset('user/images/6.png') }}" alt=" " class="img-responsive" />
						<figcaption>Kiwi Fruits</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="{{ asset('user/images/7.png') }}" alt=" " class="img-responsive" />
		...
		<div class="col-md-6 wthree_welcome_bottom_left">
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="{{ asset('user/images/8.png') }}" alt=" " class="img-responsive" />
				</div>
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="{{ asset('user/images/9.png') }}" alt=" " class="img-responsive" />
				</div>
				<div class="w3l_social_icon_gridr">
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="{{ asset('user/images/10.png') }}" alt=" " class="img-responsive" />
				</div>
				<div class="w3l_social_icon_gridr">
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="{{ asset('user/images/11.png') }}" alt=" " class="img-responsive" />
				</div>
				<div class="w3l_social_icon_gridr">
			...
			<div class="w3ls_news_grids">
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="{{ asset('user/images/3.jpg') }}" alt=" " class="img-responsive" />
				...
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="{{ asset('user/images/6.jpg') }}" alt=" " class="img-responsive" />
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3>plantation</h3></div>
						</div>
					</div>
				...
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="{{ asset('user/images/5.jpg') }}" alt=" " class="img-responsive" />
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3>plantation</h3></div>
						</div>
					</div>
...
<!-- newsletter -->
	<div class="newsletter">
		<div class="container">
			...
			<div class="w3_agile_image">
				<img src="{{ asset('user/images/12.png') }}" alt=" " class="img-responsive">
			</div>
			...
			<div class="w3agile_footer_grids">
				...
				<div class="col-md-3 agileinfo_footer_grid">
					...
					<div class="agileinfo_footer_grid_left">
						<a href="#" data-toggle="modal" data-target="#myModal"><img src="{{ asset('user/images/6.jpg') }}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="agileinfo_footer_grid_left">
						<a href="#" data-toggle="modal" data-target="#myModal"><img src="{{ asset('user/images/2.jpg') }}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="agileinfo_footer_grid_left">
						<a href="#" data-toggle="modal" data-target="#myModal"><img src="{{ asset('user/images/5.jpg') }}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="agileinfo_footer_grid_left">
						<a href="#" data-toggle="modal" data-target="#myModal"><img src="{{ asset('user/images/3.jpg') }}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="clearfix"> </div>
...
<!-- //stats -->
<!-- mislider -->
	<script src="{{ asset('user/js/mislider.js') }}" type="text/javascript"></script>
...
<!-- //mislider -->
<!-- text-effect -->
		<script type="text/javascript" src="{{ asset('user/js/jquery.transit.js') }}"></script> 
		<script type="text/javascript" src="{{ asset('user/js/jquery.textFx.js') }}"></script> 
		<script type="text/javascript">
